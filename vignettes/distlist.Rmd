...
* [`oibeta2(mu, phi, oneprob)`](../reference/oibeta2.html): One-inflated beta distribution reparameterised reparameterised by mean `mu`, precision `phi`, and one-probability `oneprob`
