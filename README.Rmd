...
The `RTMBdist` package extends the functionality of the [`RTMB`](https://kaskr.r-universe.dev/RTMB) framework by providing a collection of non-standard probability distributions that are compatible with automatic differentiation (AD). 
