...
There are also a couple of [Worked examples](https://janoleko.github.io/RTMBdist/articles/Examples.html) demonstrating how to use `RTMBdist` in practice.
...
or the development version from [GitHub](https://github.com/janoleko/RTMBdist) with:
